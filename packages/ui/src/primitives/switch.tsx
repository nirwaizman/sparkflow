...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-[hsl(var(--bg))] shadow-lg ring-0 transition-transform",
        // Logical transforms so the thumb moves toward the end side in RTL too.
